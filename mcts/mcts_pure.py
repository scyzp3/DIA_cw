# -*- coding: utf-8 -*-
"""
Pure Monte Carlo Tree Search algorithm implementation
"""
...
def rollout_policy_fn(board):
    """Simple policy function for rollout phase"""
    # Random rollout
...
def policy_value_fn(board):
    """A function that takes a board state and outputs a list of (action, probability) tuples and a score"""
...
class MCTS(object):
    ...
    def _playout(self, state):
        ...
        # Evaluate the leaf node using network
